...
import com.example.timetrack.ui.pages.LoginPage;
import com.example.timetrack.ui.pages.RegisterPage;
        ...
        event.getSource().addUIInitListener(uiEvent -> {
            ...
            ui.addBeforeEnterListener(beforeEnterEvent -> {
                ...
                if (!beforeEnterEvent.getNavigationTarget().equals(LoginPage.class)) {
                    if (beforeEnterEvent.getNavigationTarget().equals(RegisterPage.class)) {
                        return;
                    }
